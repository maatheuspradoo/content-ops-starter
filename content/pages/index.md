...
sections:
  - type: GenericSection
    title:
      text: Celebre os momentos especiais com chinelos personalizados!
      color: text-dark
      type: TitleBlock
    subtitle: ''
    text: ''
    actions:
      ...
      - label: ''
        ...
        type: Link
    media:
      url: /images/Dia dos Pais 37-38 novo.jpg
  ...
  - type: FeaturedItemsSection
    ...
    items:
      - type: FeaturedItem
        ...
        subtitle: ''
        text: >
          Entre em contato via WhatsApp para escolher qual modelo gostará de
          produzir, ou envie o modelo desejado.
        actions: []
        elementId: null
  ...
  - title:
    ...
    type: GenericSection
seo:
  metaTitle: ND Chinelos Personalizados
